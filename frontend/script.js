...
autoCompleteEndpoints = ['municipios', 'cnaes', 'naturezas']
autoCompleteEndpoints.forEach((endpoint) => {
    ...
    .then(json => {
        ...
        resultados.forEach((res) => {
            ...
            opcao.value = res['codigo']
            document.querySelector(`#${endpoint}-list`).append(opcao)
            }
        )
    })
})
