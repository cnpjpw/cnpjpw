...
CREATE INDEX razao_social_segmentos_texto_idx ON empresas (nome_empresarial text_pattern_ops);
CREATE INDEX razao_social_segmentos_texto2_idx ON empresas (nome_empresarial text_pattern_ops, cnpj_base);
...
ALTER TABLE estabelecimentos ALTER COLUMN data_inicio_atividade SET STATISTICS 200;
